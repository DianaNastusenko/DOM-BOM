...
var form = createE(document.body, 'form', {name:"login", action:"google.com"});
var inputAge = createE(form, 'input', {type:"text", name:"age", placeholder:"Age"});
var inputUsername = createE(form, 'input', {type:"text", name:"username", placeholder:"Username"});
var inputDate = createE(form, 'input', {type:"text", name:"date", placeholder:"Date"});
var buttonSubmit = createE(form, 'input', {type:"submit",  value:"Validate Me"});
